...
class TestPreparacionMokaccino(unittest.TestCase):
    def setUp(self):
        """Inicializar la maquina de cafe para cada prueba."""
        self.mc = MaquinadeCafe("Maquina de Cafe", 1.0)

    def test_preparar_mokaccino_tamano_8oz(self):
        """CP-038-1: Validar preparacion de mokaccino de 8 oz."""
        receta = {"agua_ml": 236, "cafe_g": 7, "leche_g": 10, "chocolate_g": 10}
        self._verificar_preparacion(receta, "Mokaccino", 8)

    def test_preparar_mokaccino_tamano_12oz(self):
        """CP-038-2: Validar preparacion de mokaccino de 12 oz."""
        receta = {"agua_ml": 355, "cafe_g": 14, "leche_g": 15, "chocolate_g": 15}
        self._verificar_preparacion(receta, "Mokaccino", 12)

    def test_preparar_mokaccino_tamano_16oz(self):
        """CP-038-3: Validar preparacion de mokaccino de 16 oz."""
        receta = {"agua_ml": 473, "cafe_g": 14, "leche_g": 20, "chocolate_g": 20}
        self._verificar_preparacion(receta, "Mokaccino", 16)
